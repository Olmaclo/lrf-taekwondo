...
<div x-data="coachDashboard()" x-init="init()" class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="stat-card">
            ...
            <div>
                <p class="stat-value" x-text="athletes.filter(a => a.payment_status === 'paid' || a.payment_status === 'validated').length">0</p>
        ...
        <div class="overflow-x-auto">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <template x-if="!loading && athletes.length === 0">
                        <tr><td colspan="6" class="text-center py-12">
                            <div style="display:flex;flex-direction:column;align-items:center;gap:12px;">
                                ...
                                <p class="text-surface-400 font-medium">Aucun athlète inscrit</p>
                                <p class="text-surface-600 text-sm">Commencez par inscrire votre premier athlète à une compétition.</p>
                            ...
                            <td>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-surface-500" x-text="athlete.age + ' ans'"></p>
                                    </div>
                                </div>
                            </td>
    ...
    <div x-show="modal.open"
        ...
        <div @click.stop class="modal max-w-2xl"
            ...
            <div class="modal-header">
                <h3 class="font-bold text-surface-50">Inscrire un athlète</h3>
            ...
            <div class="modal-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1" x-model="form.weight" class="form-input">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" x-model="form.license_number" class="form-input">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Club</label>
                        <input type="text" x-model="form.club" required class="form-input" value="{{ auth()->user()->club }}">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button @click="saveAthlete()" :disabled="modal.saving" class="btn btn-primary">
                    ...
                    <span x-text="modal.saving ? 'Inscription…' : 'Inscrire'"></span>
                </button>
            </div>
        </div>
    </div>
...
function coachDashboard() {
    return {
        ...
        openAddModal() {
            this.form = { first_name: '', last_name: '', birth_date: '', gender: 'M', weight: '', club: '{{ auth()->user()->club ?? '' }}', event_id: '', license_number: '' };
            this.modal = { open: true, saving: false };
        },

        async saveAthlete() {
            this.modal.saving = true;
            try {
                const res = await api.post('/api/athletes', this.form);
                if (res.success) {
                    $store.toast.success(res.message ?? 'Athlète inscrit.');
